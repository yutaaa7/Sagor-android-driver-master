...
data class SchoolDriverTripDetailResponse(

    @field:SerializedName("data")
    val data: List<SchoolDriverTripDetail>? = mutableListOf(),
...
data class SchoolDriverTripDetail(
...
data class SchoolEmergencyDetails(
...
data class SchoolDetails(
    ...
    val user: UserSchoolDetails? = null,

    @field:SerializedName("school_emergency")
    val schoolEmergency: SchoolEmergencyDetails? = null
)
