...
data class AcceptRidelResponse(
...
data class TriplocationsAccept(
...
data class DataItem(
	...
	val triplocations: List<TriplocationsAccept?>? = null,
	...
	val vehiclecategories: VehiclecategoriesAcceptRide? = null,
...
data class VehiclecategoriesAcceptRide(
