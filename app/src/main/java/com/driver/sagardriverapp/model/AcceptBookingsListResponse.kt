...
data class AcceptBookingsListResponse(

    @field:SerializedName("data")
    val data: List<AcceptBookingsList>? = mutableListOf(),
...
data class VehiclecategoriesAcceptedList(
...
data class AcceptBookingsList(
    ...
    val vehicle: VehicleAcceptedList? = null,
    ...
    val triplocations: List<TriplocationsAcceptedList?>? = null,
...
data class VehicleAcceptedList(
...
data class TriplocationsAcceptedList(
